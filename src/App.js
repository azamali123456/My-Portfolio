...
import img1 from "./Almuhasba 1.png";
import img2 from "./Almuhasba 2.png";
import img3 from "./FYP.png";
import img4 from "./Saudibank limited.png";
import img5 from "./fuelmedia 2.png";
import img6 from "./fuelmedia 3.png";
import img7 from "./fuelmedia 3.png";
import cv from "./azam.png";
function App() {
  const geoUrl =
      ...
      >
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a
              className={`${styles.navbarButton} mt-4 text-white text-decoration-none`}
              href={cv}
